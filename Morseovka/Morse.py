class Morse:
    ...
    morse_code = {dot + dash + dot * 3: "&", dash * 2 + dot * 2 + dash * 2: ",", dot * 4 + dash: "4", dot * 5: "5",
                  dot * 5: "5", dot * 3 + dash * 3 + dot * 3: "SOS", dash + dot * 3: "B", dash + dot * 2 + dash: "X",
                  dot + dash + dot: "R", dot + dash * 2: "W", dot * 2 + dash * 3: "2", dot + dash: "A", dot * 2: "I",
                  dot * 2 + dash + dot: "F", dot: "E", dot + dash + dot * 2: "L", dot * 3: "S", dot * 2 + dash: "U",
                  dot * 2 + dash * 2 + dot * 2: "?", dot + dash * 4: "1", dash + dot + dash: "K", dash + dot + dot: "D",
    ...
    def decodeMorse(morseCode, morse_code=morse_code):
    ...
    def encodeMorse(toEncode, morse_code=morse_code):
